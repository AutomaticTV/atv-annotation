...
class Images:
    ...
    def unpack_im(pack, image_type):
        ...
        elif image_type == 'jpeg' or image_type == 'jpg' or image_type == 'png':
    ...
    def pack_im(im, image_type):
        if image_type == 'numpy':
            ...
            return 'base64,' + base64.b64encode(cv2.imencode('.jpg', im)[1]).decode("utf-8")

        elif image_type == 'png':
            return 'base64,' + base64.b64encode(cv2.imencode('.png', im)[1]).decode("utf-8")
